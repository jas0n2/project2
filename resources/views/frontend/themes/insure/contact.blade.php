              ...
              <div class="info-column col-lg-6 col-md-12 col-sm-12">
                <div class="inner-column">
                  ...
                  <ul class="contact-info-list">
                    <li>
                      <span class="icon flaticon-envelope"
                        ><svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="34.813"
                          height="25.5"
                          viewBox="0 0 34.813 25.5"
                        >
                          <path
                            id="Path_1787"
                            data-name="Path 1787"
                            ...
                            transform="translate(0 -24.61)"
                            fill="#fff"
                          /></svg></span>
                      <strong>Email</strong>
                      <a href="mailto:{{$setting[0]->email1}}">{{$setting[0]->email1}}</a>
                    </li>
                    <li>
                      <span class="icon flaticon-phone"
                        ><svg
                          id="telephone"
                          xmlns="http://www.w3.org/2000/svg"
                          width="42.838"
                          height="43"
                          viewBox="0 0 42.838 43"
                        >
                          <path
                            id="Path_1788"
                            data-name="Path 1788"
                      ...
                      <strong>Call</strong>
                      <a href="tel:{{$setting[0]->phone1}}">{{$setting[0]->phone1}}</a> <br>
                      <a href="tel:{{$setting[0]->phone2}}">{{$setting[0]->phone2}}</a> <br>
                      <a href="tel:{{$setting[0]->phone3}}">{{$setting[0]->phone3}}</a>
                    </li>
                    <li>
                      <span class="icon flaticon-map"
                        ...
                        >
                          ...
                          <g
                            id="Group_729"
                            data-name="Group 729"
                            transform="translate(7.559 7.559)"
                          >
              ...
              <div class="form-column col-lg-6 col-md-12 col-sm-12">
                <div class="inner-column">
                  ...
                  <div class="contact-form">
                    <form method="post" action="{{route('postcontactus')}}" id="contact-form">
